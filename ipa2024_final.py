#######################################################################################
# Yourname: nakan ponboon
# Your student ID: 65070058
# Your GitHub Repo: https://github.com/nakanpb/IPA2024-Final.git
...
# 5. Complete the logic for each command
        ...
        if command == "create":
            ...
            # Call the function to get gigabit interface status
            responseMessage = rest.gigabit_status()
        elif command == "showrun":
            # Call the function to get the running configuration and any associated file if needed
            responseMessage, file = rest.showrun()
        else:
